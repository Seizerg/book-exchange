...
class AddBook extends Component {
	constructor(props) {
	    super(props);
	    this.state = {title:"", img:'/img/yourbook.jpg', condition:'Good', description:""};
	}
			...
			<div>
				<Header leftBtn={hLeft} title="Add Book" rightBtn={hRight}/>
					<main className="add-book scroll">
					    ...
					    <input name="title" type="text" className="title" value={this.state.title} onChange={this.onChange.bind(this)} placeholder="Enter Your Book"/>
					    ...
					    <textarea name="description" className="description" placeholder="Book Description..." value={this.state.description} onChange={this.onChange.bind(this)}></textarea>
